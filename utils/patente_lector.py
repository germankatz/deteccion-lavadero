...
<<<<<<< Updated upstream
def leer_patente(imagen_patente):
    """
    ...
    return ""
=======
def leer_patente(img_patente,roi):
    """
    Realiza OCR sobre la imagen de la patente y devuelve el texto.
    """
    ...
    #roi = (0, 0, ancho, alto)
    #img = rectificar_roi(img_rotada,roi,25)
    

    #x, y, w, h = roi
    #img_recrotada = img_patente[y:y+h, x:x+w]
    cv2.imshow("Patente rotada", img_patente)
    cv2.waitKey(0)
    ...
    izq, centro, der = dividir_patente_en_tres(img_patente)
