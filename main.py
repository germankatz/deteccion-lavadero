...
from interfaz import elegir_roi, seleccionar_video, elegir_tolerancia_frames, elegir_metodo_patente, calcular_homografia
from utils.roi_selector import RoiSelector
from utils.roi_rectifier import rectificar_roi, rectificar_roi_hardcoded
from utils.patente_detector import detectar_patentes_pattern_matching, detectar_patente_contorno
...
def main():
    ...
    if opcion == "1":
        roi_selector.usar_roi_por_defecto(video_path)
    elif opcion == "2":
    ...
    if metodo_patente == "pattern_matching":
        ...
        while True:
            ...
            roi_rectificado = rectificar_roi_hardcoded(frame, video_path, roi_selector.roi, M, dst_corners)
    ...
    # Metodo de agu
        ...
        while True:
            ...
            bw_image, mejor_candidato, img_contornos = detectar_patente_contorno(roi_rect)
